...
function Sidebar() {
  ...
  return (
    <div className="w-full px-4 py-6 bg-white border-r xl:shadow-lg xl:h-screen border-border">
      <Link to="/">
        <img
          src="/images/logo.png"
          alt="logo"
          className="object-contain w-2/4 h-12 ml-4"
        />
      </Link>
      <div className="gap-2 mt-12 flex-colo">
